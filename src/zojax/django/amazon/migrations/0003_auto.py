...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sites on 'BookSearch'
        db.create_table('amazon_booksearch_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('booksearch', models.ForeignKey(orm['amazon.booksearch'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('amazon_booksearch_sites', ['booksearch_id', 'site_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field sites on 'BookSearch'
        db.delete_table('amazon_booksearch_sites')
    ...
    models = {
        'amazon.book': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'amazon_book_related'", 'blank': 'True', 'to': "orm['sites.Site']"}),
        ...
        'amazon.booksearch': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'booksearch_sites'", 'blank': 'True', 'to': "orm['sites.Site']"})
        },
        'sites.site': {
